...
struct ContentView: View {
    ...
    /**Buttons**/
//    var body: some View {
//        //        ///we can attach a role to the button, which iOS can use to adjust its appearance both visually and for screen readers.
...
//                .buttonStyle(.bordered)
//            /// customize the colors used for a bordered button, use the tint() modifier
//            Button("Button 3") { }
